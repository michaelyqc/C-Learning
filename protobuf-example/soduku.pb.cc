...
void protobuf_AssignDesc_soduku_2eproto() {
  protobuf_AddDesc_soduku_2eproto();
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_soduku_2eproto);
}
...
void protobuf_ShutdownFile_soduku_2eproto() {
...
void protobuf_AddDesc_soduku_2eproto() {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "soduku.proto", &protobuf_RegisterTypes);
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_soduku_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_soduku_2eproto {
  StaticDescriptorInitializer_soduku_2eproto() {
    protobuf_AddDesc_soduku_2eproto();
  }
} static_descriptor_initializer_soduku_2eproto_;
...
const SudokuRequest& SudokuRequest::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_soduku_2eproto();
